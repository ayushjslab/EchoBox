...
import { Copy, Check, Zap, Code, CheckCircle, ArrowRight } from "lucide-react";

export default function AddWebsitePage() {
  const [step, setStep] = useState(1);
  const [siteName, setSiteName] = useState("");
  const [siteUrl, setSiteUrl] = useState("");
  const [siteId] = useState("1234");
  ...
  const handleGenerate = () => {
    ...
    const script = `<script src="https://echomark.vercel.app/widget.js?siteId=${siteId}"></script>`;
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start mt-16">
            ...
            <div className="bg-white rounded-2xl border border-emerald-100 p-8 shadow-lg hover:shadow-xl transition-shadow">
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
                >
                  <Zap size={18} />
                  Generate Script
                </button>
              ...
              <div className="grid gap-4">
                <div className="flex gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Copy the generated script and paste it into your website&apos;s
                      HTML
                    </p>
                  </div>
                </div>
                <div className="flex gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Start tracking visitor behavior immediately after adding
                      the script
                    </p>
                  </div>
                </div>
          ...
          {/* Right Side - Script Display / Success */}
          <div>
            {generatedScript ? (
              <div className="space-y-6">
                {/* Success State */}
                <div className="bg-gradient-to-br from-emerald-50 to-white rounded-2xl border-2 border-emerald-200 p-8 text-center space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                  >
                    Go to Dashboard
                    <ArrowRight size={18} />
                  </button>
              ...
              <div className="bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 rounded-2xl p-8 text-white shadow-2xl h-full flex flex-col justify-center">
                <div className="space-y-6">
                  <div>
